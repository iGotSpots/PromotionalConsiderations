...
// PromotionalConsiderations version - intended for display purpose only
#define PROMO_VERSION_MAJOR       1
#define PROMO_VERSION_MINOR       0
#define PROMO_VERSION_REVISION    0
#define PROMO_VERSION_BUILD       0

static const int PROMO_VERSION =
                           1000000 * PROMO_VERSION_MAJOR
                         +   10000 * PROMO_VERSION_MINOR
                         +     100 * PROMO_VERSION_REVISION
                         +       1 * PROMO_VERSION_BUILD;

// PromotionalConsiderations version - reference for code tracking
