/*
 * Qt4 PromotionalConsiderations GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Bitcoin Developers 2011-2012
 * The PromotionalConsiderations Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Promotional Consideration provided by FreeStaking.com"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/PromotionalConsiderations_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PromotionalConsiderations address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/PromotionalConsiderations_tooltip"), tr("&About PromotionalConsiderations"), this);
    aboutAction->setToolTip(tr("Show information about PromotionalConsiderations"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PromotionalConsiderations"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/PromotionalConsiderations_tooltip"), tr("Show/Hide &PromotionalConsiderations"), this);
    toggleHideAction->setToolTip(tr("Show or hide the PromotionalConsiderations window"));
    exportAction = new QAction(QIcon(":/icons/export"), tr("&Sheets..."), this);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/PromotionalConsiderations_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/PromotionalConsiderations_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/PromotionalConsiderations_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PromotionalConsiderations client"));
    trayIcon->setIcon(QIcon(":/icons/PromotionalConsiderations_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSBAR_PROMONSIZE,STATUSBAR_PROMONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PromotionalConsiderations network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if(secs < 90*60 && count >= nTotalBlocks)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/synced").pixmap(STATUSBAR_PROMONSIZE, STATUSBAR_PROMONSIZE));
    }
    else
    {
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_open").pixmap(STATUSBAR_PROMONSIZE,STATUSBAR_PROMONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_closed").pixmap(STATUSBAR_PROMONSIZE,STATUSBAR_PROMONSIZE));
