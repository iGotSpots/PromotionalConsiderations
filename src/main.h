...
static const int STAKE_TARGET_SPACING = 600;
...
public:
    ...
    {
        // PromotionalConsiderations: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // PromotionalConsiderations: get transaction coin age
...
public:
    ...
    // PromotionalConsiderations: block signature - signed by coin base txout[0]'s owner
    ...
    // PromotionalConsiderations: two types of block: proof-of-work or proof-of-stake
    ...
    // PromotionalConsiderations: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // PromotionalConsiderations: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // PromotionalConsiderations: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // PromotionalConsiderations: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // PromotionalConsiderations: block index flags
    enum  
    {
