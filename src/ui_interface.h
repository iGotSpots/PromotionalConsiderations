...
#define wxPROMON_EXCLAMATION      0x00000100
#define wxPROMON_HAND             0x00000200
#define wxPROMON_WARNING          wxPROMON_EXCLAMATION
#define wxPROMON_ERROR            wxPROMON_HAND
#define wxPROMON_QUESTION         0x00000400
#define wxPROMON_INFORMATION      0x00000800
#define wxPROMON_STOP             wxPROMON_HAND
#define wxPROMON_ASTERISK         wxPROMON_INFORMATION
#define wxPROMON_MASK             (0x00000100|0x00000200|0x00000400|0x00000800)
