...
bool CTxDB::LoadBlockIndex()
{
    ...
    loop
    {
        ...
        if (strType == "blockindex" && !fRequestShutdown)
        {
            ...
            // PromotionalConsiderations: build setStakeSeen
    ...
    BOOST_FOREACH(const PAIRTYPE(int, CBlockIndex*)& item, vSortedByHeight)
    {
        ...
        // PromotionalConsiderations: calculate stake modifier checksum
    ...
    // PromotionalConsiderations: load hashSyncCheckpoint
