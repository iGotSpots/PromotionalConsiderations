...
// Copyright (c) 2011-2015 The PromotionalConsiderations developers
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PromotionalConsiderations " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are PromotionalConsiderations dns seeds.
static const char *strDNSSeed[][2] = {
    {"seed", "promo.freestaking.com"},
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // PromotionalConsiderations enables dns seeding with testnet too
    {
...
// PromotionalConsiderations: stake minter thread
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer.  PromotionalConsiderations is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // IRC disabled with PromotionalConsiderations
    ...
    // PromotionalConsiderations: mint proof-of-stake blocks in the background
